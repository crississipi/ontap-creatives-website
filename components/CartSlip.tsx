...
const CartSlip = () => {
  ...
  return (
    <div className='h-32 w-full p-3 gap-3 border-b border-black/10 grid grid-cols-5 relative'>
        <div className='col-span-3 flex pr-12'>
            ...
            <div className='h-full flex gap-3'>
                <span className='h-full aspect-square bg-neutral-400'></span>
            ...
            <span className='h-full flex items-center justify-center font-extrabold text-base text-dark-blue ml-auto'>
                <p><span className='text-sm'>₱</span> 2,500.00</p>
            </span>
        </div>
        <span className='h-full flex items-center justify-center col-span-1 z-30 font-extrabold text-sm text-dark-blue'>
        ...
        <span className='h-full flex items-center justify-center col-span-1 font-extrabold text-dark-blue'>
            <p><span className='text-sm'>₱</span> 2,500.00</p>
        </span>
            <button type="button" className='px-1 h-[80%] z-30 ml-auto absolute top-1/2 -translate-y-1/2 right-0 text-2xl text-rose-600 border border-rose-50 hover:bg-rose-300 focus:bg-rose-500 focus:text-white ease-out duration-200'><HiOutlineTrash /></button>
        </div>
  )
}
