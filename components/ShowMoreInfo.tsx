    ...
    const finalProductDesc = product?.description ? <p>{product.description}</p> : <p></p>;
    ...
    return (
        <div className='h-full w-full fixed top-16 md:top-0 left-0 bg-white/15 backdrop-blur-sm z-100 flex items-center justify-center'>
            ...
            <div ref={!showLogin ? clickRef : null} className='h-full w-full md:h-4/5 lg:h-3/4 md:w-4/5 lg:w-[90%] bg-white shadow-md rounded-2xl grid grid-cols-1 lg:grid-cols-10 lg:gap-1 lg:p-5 relative overflow-x-hidden lg:overflow-auto'>
                ...
                <div className='col-span-7 h-full grid grid-cols-5 p-5 pb-0 pr-0 pl-0 lg:pl-5 lg:pt-3 gap-y-5 lg:overflow-x-hidden items-start relative'>
                    ...
                    <div className='col-span-full lg:col-span-3 w-full h-full flex flex-col justify-start px-5 lg:px-0 relative'>
                        ...
                        <span className='col-span-full leading-5 text-lg px-5 lg:px-0 lg:my-10'>{finalProductDesc}</span>
                        ...
                        {product.price.ontap === 0 ? (
                            ...
                            <>
                                ...
                                <p className='hidden lg:block text-4xl'>{(priceOption === 'ontap' ? product.price.ontap * quantity : product.price.custom! * quantity).toLocaleString('en-US', { minimumFractionDigits: 2,maximumFractionDigits: 2, })}</p>
                                <p className='lg:hidden text-4xl'>{(priceOption === 'ontap' ? product.price.ontap: product.price.custom!).toLocaleString('en-US', { minimumFractionDigits: 2,maximumFractionDigits: 2, })}</p>
                            </>
                        )}
                        </span>
                                            ...
                                            {product.price.ontap === 0 ? (
                                                <p className='text-2xl'>Upon Inquiry</p>
                                                    ...
                                                    <>
                                                        ...
                                                        <p className='text-3xl md:text-4xl'>{(priceOption === 'ontap' ? product.price.ontap * quantity : product.price.custom! * quantity).toLocaleString('en-US', { minimumFractionDigits: 2,maximumFractionDigits: 2, })}</p>
                                                    </>
                                                )}
                                            </span>
                                        </div>
