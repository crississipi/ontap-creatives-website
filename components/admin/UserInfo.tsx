  ...
  return (
    <div className='w-full h-full flex flex-col px-5 py-10 pb-5 gap-5 bg-neutral-100'>
        <div className='w-full flex items-center justify-between lg:pr-5'>
          <h1 className='text-2xl font-semibold'>Visitor's Analytics</h1>
        </div>
        <div className='h-full w-full grid grid-cols-5 gap-x-4 overflow-hidden'>
          <div className='col-span-1 h-full flex flex-col items-center gap-5'>
            <div className='h-auto w-full rounded-md bg-white shadow-md shadow-neutral-200 p-5'>
              <h3 className='font-semibold text-sm mb-5'>User Information</h3>
              <h2 className='font-bold text-lg'>Juan Dela Cruz</h2>
              <h3 className='text-dark-blue mb-14'>Panday</h3>
              <span className='flex items-center gap-2'><RiMapPin2Line /> Metro Manila, Philippines</span>
              <h3 className='flex items-center justify-between'>Engagement: <span className='font-semibold'>00:13:00</span></h3>
              <h3 className='flex items-center justify-between mb-14'>Date Visited: <span className='font-semibold'>22.09.25 10:00</span></h3>
              <a href='tel:+639183465678' className='flex w-min text-nowrap mx-auto gap-3 items-center border rounded-md py-3 px-5 hover:bg-light-blue hover:border-blue focus:bg-violet focus:border-transparent focus:text-white ease-out duration-200'><RiPhoneLine className='text-xl'/> +63 918 346 5678</a>
            </div>
          ...
          <div className='col-span-3 h-full flex flex-col items-center justify-center gap-5 overflow-hidden'>
            <div className='h-full w-full rounded-md bg-white shadow-md shadow-neutral-200 flex flex-col gap-3 p-5'>
          ...
          <div className='col-span-1 h-full flex flex-col items-center gap-5'>
            <div className='h-auto w-full rounded-md bg-white shadow-md shadow-neutral-200 flex flex-col items-center p-5 gap-5'>
              ...
              <Image
                ...
                className='h-auto w-full object-contain object-center mt-0.5'
              />
